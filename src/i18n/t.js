  ...
  resources: {
    en: {
      translation: {
        ...
        du_lieu_cap_nhat_som: 'Dữ liệu sẽ sớm được cập nhật tại đây.',
        ...
        dang_ki_voi: 'Đăng kí với',
        txt_da_co_tai_khoan: 'Đã có tài khoản',
        txt_announcement: 'Vui lòng xác nhận tài khoản tại email vừa đăng kí.',
        announcement: 'Announcement',
        txt_dang_nhap_ngay: 'Đăng nhập ngay',
        txt_xin_chao: 'Xin chào',
        history: 'Lịch sử đơn hàng',
        message_cancel_order: ' Bạn có chắc muốn huỷ giao dịch này không?',
        message_sure_order: 'Bạn có chắc muốn giao dịch lại không?',
        txt_back: 'Quay lại',
