...
Route::prefix('v1/')->group(function () {
    Route::middleware(['auth:api,stores'])->get('location', 'LocationController@getLocations');
    Route::middleware(['auth:api,stores'])->get('location/{id}', 'LocationController@getLocationById');
...
Route::prefix('v1/user')->group(function () {
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::put('user-update-image', 'UserAuthController@updateImageUser');
        ...
        Route::put('update-phone', 'UserAuthController@updatePhoneUser');
...
Route::prefix('v1/store')->group(function () {
    ...
    Route::group(['middleware' => 'auth:stores'], function () {
        ...
        Route::put('store-update-image', 'StoreAuthController@updateImageStore');
...
Route::prefix('v1/')->group(function () {
    ...
    Route::group(['middleware' => 'auth:stores'], function () {
        ...
        Route::post('servive-search', 'ServiceController@searchService'); // search auth for user
    });
