...
class AuthStoreChangsePassRequest extends FormRequest
{
    use SanitizesInput;
    ...
    {
        return [
            'old_password' =>  ['required', 'string', 'regex:/(^[a-zA-Z0-9||@#$%&||^\s]+$)+/'],
