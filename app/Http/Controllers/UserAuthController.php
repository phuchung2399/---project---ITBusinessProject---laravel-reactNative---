...
use App\Http\Requests\UserRequest\AuthUserUpdateProfileRequest;
...
use App\Http\Requests\UserRequest\AuthUserRequest;
...
class UserAuthController extends Controller
{
	...
	public function changePasswordUser(AuthUserChangsePassRequest $request, $id)
	{
		return $this->userService->changePasswordUser($request, $id);
	}
