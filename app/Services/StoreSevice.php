...
class StoreSevice
{
    ...
    function login($request)
    {
        ...
        if (Hash::check($request->password,  $store->password) === true && $store->auth == 'store') {
            ...
            return Response::responseLoginSuccess($token_store, $data, 'store', HttpStatus::SUCCESS_RESPONSE);
        } else {
            return Response::responseMessage(HttpStatus::UNAUTHORIZED,  'Đăng nhập thất bại');
        }
    }
    ...
    {
        $store =  $this->requestData($request, $this->store);
    ...
    function updateStore($request, $id)
    {
        if ($this->storeRepository->checkStoreById($id)) {
            ...
            return Response::responseMessage(HttpStatus::BAD_REQUEST,  "Cập nhập thất bại");
        }
    }
    ...
    function handleUpdate($store, $request)
    {
        ...
        $this->storeRepository->updateStore($this->requestData($request, $store));
    ...
    function detail()
    {
        ...
        return Response::responseSuccess(HttpStatus::SUCCESS_RESPONSE, $store);
    }
     ...
     * @param store *store from selectStoreById in storeRepository
     **/
    function requestData($request, $store)
    {
