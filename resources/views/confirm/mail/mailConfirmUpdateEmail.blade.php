                                        ...
                                        <table role="presentation" aria-hidden="true" cellspac ing="0" cellpadding="0" border="0" align="center" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 15px; font-family: 'Source Sans Pro', sans-serif; font-size: 18px; line-height: 24px; color: #1B2733;">
                                                    ...
                                                    <hr>
                                                    Đây là email của hệ thống ứng dụng Nail App<br>Vui lòng nhấn vào
                                                    <strong>link</strong> để xác nhận thay đổi email
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" class="container">
                                                        <tr style="justify-content: center;">
                                                            <td style="border-radius: 3px;" bgcolor="#fd4084">
                                                                <a class="btn" href='http://127.0.0.1:8000/{{$data["url"]}}/{{$data["id"]}}/{{$data["token"]}}' target="_blank" style="font-size: 18px; font-family: 'Source Sans Pro', sans-serif; color: #ffffff; text-decoration: none; text-decoration: none; padding: 10px 20px; border-radius: 2px; border: 1px solid  #fd4084; display: inline-block;">LINK</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
