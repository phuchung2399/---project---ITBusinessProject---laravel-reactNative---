                            ...
                            <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
                                <tr>
                                    <td style="padding: 20px;">
                                        <table role="presentation" aria-hidden="true" cellspac ing="0" cellpadding="0" border="0" align="center" width="100%">
                                            <center><img src="https://doc-00-40-docs.googleusercontent.com/docs/securesc/f3ca1rl4legophpggfu3etuq49ot5onn/ph9n1j3i038i75luh8kmg5jhf21f92h6/1595227275000/08726118481005996304/08726118481005996304/1JHJ5wLLpQfZJ1WXjeGgE-bZa6YzF_ipl?e=view&authuser=0&nonce=ck8ureb14r73u&user=08726118481005996304&hash=gef5gg9eimccvokl87h90ne7me8rea2s" alt=""></center>
                                            <hr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 15px; font-family: 'Source Sans Pro', sans-serif; font-size: 18px; line-height: 24px; color: #1B2733;">
                                                    Đây là email của hệ thống ứng dụng Nail App
                                                    <hr>
                                                    Trước tiên, cảm ơn bạn đã chọn và đăng ký tài khoản cũng như tin
                                                    dùng dịch vụ của Nail App<br>Vui lòng nhấn vào
                                                    <strong>confirm</strong> để xác nhận đăng ký tài khoản
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" class="container">
                                                        <tr style="justify-content: center;">
                                                            <td style="border-radius: 3px;" bgcolor="#fd4084">
                                                                <a class="btn" <a href='http://127.0.0.1:8000/{{$data["url"]}}/{{$data["id"]}}' target="_blank" style="font-size: 18px; font-family: 'Source Sans Pro', sans-serif; color: #ffffff; text-decoration: none; text-decoration: none; padding: 10px 20px; border-radius: 2px; border: 1px solid  #fd4084; display: inline-block;">CONFIRM</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                ...
                <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="450" class="container">
                    ...
                    <tr>
                        <td align="center" style="font-family: 'Source Sans Pro', sans-serif; font-size: 11px; line-height: 16px; padding-bottom: 20px; color: #aaaaaa;">
                            <!-- Unsubscribe link -->
                            <unsubscribe>Thank you</unsubscribe>
                        </td>
                    </tr>
                </table>
