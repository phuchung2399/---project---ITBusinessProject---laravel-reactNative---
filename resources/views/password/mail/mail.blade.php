                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        <table role="presentation" aria-hidden="true" cellspac ing="0" cellpadding="0" border="0" align="center" width="100%">
                                            <center><img src='https://drive.google.com/uc?export=view&id=1JHJ5wLLpQfZJ1WXjeGgE-bZa6YzF_ipl' alt=""></center>
                                            <hr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 15px; font-family: 'Source Sans Pro', sans-serif; font-size: 18px; line-height: 24px; color: #1B2733;">
                                                    ...
                                                    <hr><br>Chúng tôi hy vọng
                                                    bạn có thể cẩn thận hơn về việc ghi nhớ mật khẩu của mình<br>Vui lòng nhấn vào
                                                    <strong>link</strong> để xác nhận thay đổi mật khẩu
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" class="container">
                                                        <tr style="justify-content: center;">
                                                            <td style="border-radius: 3px;" bgcolor="#fd4084">
                                                                <a class="btn" <a href='http://127.0.0.1:8000/{{$data["url"]}}/{{$data["id"]}}/{{$data["token"]}}' target="_blank" style="font-size: 18px; font-family: 'Source Sans Pro', sans-serif; color: #ffffff; text-decoration: none; text-decoration: none; padding: 10px 20px; border-radius: 2px; border: 1px solid  #fd4084; display: inline-block;">LINK</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
